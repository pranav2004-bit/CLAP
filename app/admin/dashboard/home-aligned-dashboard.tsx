...
export default function AdminDashboard() {
  ...
  // Mock data matching home screen patterns
  const studentData = [
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sidebar - Matching home screen navigation style */}
      <aside className={`fixed left-0 top-0 z-50 h-screen w-64 bg-card border-r border-border transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:z-auto shadow-lg`}>
        <div className="flex flex-col h-full">
          {/* Logo Header - Matching home screen */}
          ...
          {/* Navigation - Matching home screen link styles */}
      ...
      <main className={`transition-all duration-300 ${sidebarOpen ? 'ml-0' : ''} lg:ml-64`}>
        {/* Header - Matching home screen hero section style */}
        ...
        <div className="p-6">
          {/* OVERVIEW TAB - Matching home screen design patterns */}
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              {/* Stats Grid - Matching home screen stats section */}
              ...
              {/* Test Performance - Matching home screen test cards */}
          ...
          {/* STUDENTS TAB - Matching home screen card design */}
          {activeTab === 'students' && (
            <div className="space-y-8">
          ...
          {/* BATCHES TAB - Matching card design patterns */}
          {activeTab === 'batches' && (
            <div className="space-y-8">
              <div className="text-center">
          ...
          {/* TESTS TAB - Matching home screen test structure */}
          {activeTab === 'tests' && (
            <div className="space-y-8">
              <div className="text-center">
          ...
          {/* ANALYTICS TAB - Matching feature card design */}
          {activeTab === 'analytics' && (
            <div className="space-y-8">
              <div className="text-center">
